...
public final class ActivitySignupBinding implements ViewBinding {
  ...
  private ActivitySignupBinding(@NonNull ConstraintLayout rootView, @NonNull TextView loginRedirect,
      @NonNull ConstraintLayout main, @NonNull Button signupButton,
  ...
  public static ActivitySignupBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivitySignupBinding((ConstraintLayout) rootView, loginRedirect, main,
          signupButton, signupPassword, signupUsername);
    }
